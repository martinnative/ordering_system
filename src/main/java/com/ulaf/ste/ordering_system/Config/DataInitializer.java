...
public class DataInitializer {
    ...
    public void initializeData() throws NotFoundByIdException {
        ...
        productService.createProduct(new Product("Margarita Pizza", 280.0,"Pizza with cheese and ketchup",true,true, productIngredients, image1, category));
        productService.createProduct(new Product("Kaprichioza Pizza", 320.0,"Pizza with ham, cheese and mushrooms",true,true, productIngredients2, image2, category));
